...
MediaRoutes.post("/create", [authorize], upload.single("mediaImage", "mediaVideo", "mediaSpotify"), create);
MediaRoutes.patch("/:id", [authorize], upload.single("mediaImage", "mediaVideo", "mediaSpotify"), update);
